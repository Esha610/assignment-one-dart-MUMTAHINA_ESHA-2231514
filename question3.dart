...
class BankAccount {
  ...
  void deposit(double amount) {
    ...
    balance += amount;
    print(
        "Deposited \$${amount} to $accountHolder's account. New balance: \$${balance}");
  }
  ...
  void withdraw(double amount) {
    ...
    if (amount <= balance) {
      balance -= amount;
      print(
          "Withdrew \$${amount} from $accountHolder's account. Remaining balance: \$${balance}");
    } else {
      print(
          "Insufficient funds for $accountHolder! Available balance: \$${balance}");
    }
  }
